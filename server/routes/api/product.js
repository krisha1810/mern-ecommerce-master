 ...
 * /product/list/select:
 *   get:
 *     summary: Get product names for selection (Auth required)
 *     tags: [Product]
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
 *         description: List of products (names only)
 */
 ...
 * /product:
 *   get:
 *     summary: Get all products (Admin/Merchant)
 *     tags: [Product]
 *     security:
 *       - bearerAuth: []
 *     responses:
 ...
 * /product/{id}:
 *   get:
 *     summary: Get product by ID (Admin/Merchant)
 *     tags: [Product]
 *     security:
 *       - bearerAuth: []
 *     parameters:
