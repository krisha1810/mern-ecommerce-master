 ...
 * /order/add:
 *   post:
 *     summary: Place a new order (Auth required)
 *     tags: [Order]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 * /order/search:
 *   get:
 *     summary: Search orders (Auth required)
 *     tags: [Order]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *         schema:
 *           type: string
 *         description: Search query (e.g. Order ID)
 *     responses:
 *       200:
 ...
 * /order:
 *   get:
 *     summary: Get all orders (Admin/Merchant)
 *     tags: [Order]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 * /order/me:
 *   get:
 *     summary: Get my orders (Auth required)
 *     tags: [Order]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 * /order/{orderId}:
 *   get:
 *     summary: Get order by ID (Auth required)
 *     tags: [Order]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *   delete:
 *     summary: Cancel an order (Auth required)
 *     tags: [Order]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *   put:
 *     summary: Update order item status (Auth required)
 *     tags: [Order]
 *     security:
 *       - bearerAuth: []
 *     parameters:
